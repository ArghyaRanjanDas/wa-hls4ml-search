...
echo "Submitting Part 04/10: array tasks 123-163 (designs 1968-2623)..."
JOB_ID=$(sbatch --array=123-163%12 --parsable "$RUN_DIR/job_array.sh")
echo "Part 04 submitted: job $JOB_ID"
echo "part=04 job=$JOB_ID tasks=123-163 designs=1968-2623" >> "$RUN_DIR/slurm_job_ids.txt"
