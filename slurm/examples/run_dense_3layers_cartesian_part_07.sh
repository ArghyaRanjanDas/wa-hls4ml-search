...
echo "Submitting Part 07/10: array tasks 246-286 (designs 3936-4591)..."
JOB_ID=$(sbatch --array=246-286%12 --parsable "$RUN_DIR/job_array.sh")
echo "Part 07 submitted: job $JOB_ID"
echo "part=07 job=$JOB_ID tasks=246-286 designs=3936-4591" >> "$RUN_DIR/slurm_job_ids.txt"
