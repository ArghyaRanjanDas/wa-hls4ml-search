...
echo "Submitting Part 02/10: array tasks 41-81 (designs 656-1311)..."
JOB_ID=$(sbatch --array=41-81%12 --parsable "$RUN_DIR/job_array.sh")
echo "Part 02 submitted: job $JOB_ID"
echo "part=02 job=$JOB_ID tasks=41-81 designs=656-1311" >> "$RUN_DIR/slurm_job_ids.txt"
