...
python iter_manager_catapult.py \
  ...
  --flow_config_json configs/catapult_flow/config_catapult_flow_rf1.json                     $(: HLS flow parameters, RF=1) \
  --gen_model_config_json configs/model_sweeps/config_dense_3layers_bw6_10_14.json          $(: 3-layer: sizes 4-16, relu/tanh/sigmoid, 6/10/14-bit) \
