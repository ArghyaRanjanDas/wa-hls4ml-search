...
python iter_manager_catapult.py \
  -o $SCRATCH/catapult_dense_2layers_cartesian_bw6_10_14                $(: output directory) \
  ...
  --gen_model_config_json configs/model_sweeps/config_dense_2layers_bw6_10_14.json           $(: 2-layer: in/hidden/out 4-32, relu/tanh/sigmoid, 6/10/14-bit) \
  --cartesian                                                            $(: enumerate all 1728 configs, no random sampling) \
