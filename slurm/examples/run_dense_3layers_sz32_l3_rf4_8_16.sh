#!/bin/bash
# Run sz32-l3 RF=4, RF=8, RF=16.
# (l3 RF=1 already complete and archived.)
#
# Self-recovers from squeue ghost COMPLETING and SLURM timeouts:
#   - sacct-based polling (immune to squeue ghosts)
#   - resume_if_incomplete: detects missing tarballs after iter_manager exits,
#     resubmits only the missing designs, waits via sacct, verifies final count
...
# The script will detect incomplete tarballs and resume automatically.
#
...
#   bash slurm/examples/run_dense_3layers_sz32_l3_rf4_8_16.sh
