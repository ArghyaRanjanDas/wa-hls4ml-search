...
run_group l2 16 config_dense_3layers_sz32_l2.json config_catapult_flow.json

run_group l3  1 config_dense_3layers_sz32_l3.json config_catapult_flow_rf1.json
