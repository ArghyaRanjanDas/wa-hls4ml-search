...
echo "Submitting Part 03/10: array tasks 82-122 (designs 1312-1967)..."
JOB_ID=$(sbatch --array=82-122%12 --parsable "$RUN_DIR/job_array.sh")
echo "Part 03 submitted: job $JOB_ID"
echo "part=03 job=$JOB_ID tasks=82-122 designs=1312-1967" >> "$RUN_DIR/slurm_job_ids.txt"
